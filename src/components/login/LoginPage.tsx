      ...
      <div className='flex flex-col relative mx-auto mt-8 mb-8 min-w-[18rem] min-h-[10rem] bg-white p-5 pt-6 pb-6 border rounded-2xl shadow-lg'>
        ...
        <form action="#" className='border-t-2 border-b-2 border-t-gray-200 border-b-gray-200 pt-4 pb-4'>
          ...
          <div className="flex w-full min-h-max items-center relative mb-4">
            <input type={`${isVisible? "password": "text"}`} id='password' placeholder="*********" className='border border-gray-200 rounded-lg focus:border-sky-400 outline-none pr-9 w-full' required />
